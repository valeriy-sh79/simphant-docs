...
Для вирішення проблеми надлишкових зв'язків застосовується метод регуляризації матриці (регуляризація Тихонова). Принцип його роботи такий: замість забезпечення нескінченної жорсткості зв'язків у діагональ матриці вноситься незначна величина «податливості» пружності. Це дозволяє миттєво усунути виродженість матриці без зміни її розмірності.

У контексті регуляризації Тихонова значення, яке задається в інтерфейсі користувача (наприклад, -1E-7), фізично являє собою податливість зв'язку (м/Н) — величину, зворотну до жорсткості. З математичної точки зору це еквівалентно встановленню в зчленуванні віртуальної пружини, що дозволяє розподілити навантаження між зчленуваннями.
